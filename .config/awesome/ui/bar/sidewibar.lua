...
awesome.connect_signal("signal::battery", function(percentage, state)
    ...
    battery_icon.markup = "<span foreground='" .. beautiful.xforeground .. "'>" ..
                              bat_icon .. "</span>"
end)
...
awesome.connect_signal("signal::volume", function(vol, muted)
    ...
    if muted then vol_icon = "<span font_desc = '1' rise = '-30000' >🔇</span>" end

    volume_prog.value = vol

    volume_icon.markup = "<span foreground='" .. beautiful.xforeground.. "'>" ..vol_icon .. "</span>"
...
local clock = wibox.widget {
    ...
    format = "<span foreground ='" .. beautiful.xforeground.. "'> %l:%M%p </span>",
    align = "center",
    valign = "center",
...
screen.connect_signal("request::desktop_decoration", function(s)
    ...
    s.mypanel = wibox({
        ...
        width = beautiful.panel_width-beautiful.wibar_height,
    ...
    s.mywibox:struts{top_left = beautiful.wibar_width}
    ...
    s.mywibox.widget = wibox.widget {
		...
		wrap_widget(require('module.network')()),
		clock,
                wrap_widget({
                    s.mylayoutbox,
                    top = dpi(5),
